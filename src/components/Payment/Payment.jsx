  ...
  return (
    <div className="w-full 800px:w-[95%] bg-[#fff] rounded-mb p-5 pb-8">
      ...
      <div>
        ...
        {/* pay with paypal */}
        {select === 2 ? (
          <div className="w-full flex borderr-b">
            <div
            ...
            {open && (
              <div className="w-full fixed top-0 left-0 bg-[#00000039] h-screen flex items-center justify-center z-[99999]">
                <div className="w-full 800px:w-[40%] h-screen 800px:h-[80vh] bg-white rounded-[5px] shadow flex flex-col justify-center p-8 relative overflow-scroll">
