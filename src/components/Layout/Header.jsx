...
const Header = ({ activeHeading }) => {
  ...
  const [wishtlistOpen, setWishlistOpen] = useState(false);
      ...
      <div className={`${styles.section}`}>
        <div className="hidden 800px:h-[50px] 800px:my-[20px] 800px:flex items-center justify-between">
          ...
          <div className="w-[50%] relative">
            ...
            />
            <AiOutlineSearch className="absolute right-2 top-1.5 cursor-pointer" />
          ...
          <div className={`${styles.button}`}>
            <Link
              to={`${isSellerAuthenticated ? "/dashboard" : "/shop-create"}`}
            >
          ...
          <div className="fixed w-full bg-[#0000005f] z-20 h-full top-0 left-0">
            <div className="fixed w-[60%] bg-[#fff] h-screen top-0 left-0 z-10">
              ...
              <div className={`${styles.button} ml-4 !rounded-[4px] !h-[40px]`}>
                <Link
                  to={`${
                    isSellerAuthenticated ? "/dashboard" : "/shop-create"
                  }`}
                >
                  <h1 className="text-[#fff] flex items-center">
                    {isSellerAuthenticated ? "Go Dashboard" : "Become Seller"}
              ...
              <br />
              <div className="flex !mb-[40px] w-full justify-center">
                {isAuthenticated ? (
                  <div>
                    <Link to="/profile">
                      <img
                        className="w-[60px] h-[60px] rounded-full border-[3px] border-[#b7bcbd]"
                        src={`${backend_url}${user.avatar}`}
                        alt=""
                      />
                    </Link>
                  ...
                  <>
                    <Link
                      className="text-[18px] pr-[10px] text-[#1b1b1b]"
                      to="/login"
                    >
                      Login /
                    </Link>
                    <Link className="text-[18px]  text-[#1b1b1b]" to="/sign-up">
                      Sign up
                    </Link>
                  </>
                )}
